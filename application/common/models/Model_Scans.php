    ...
    */
    ...
    public function getExist()
    {
        return $this->rowSelectOne('id',
                                   self::TABLE_NAME,
                                   'id_doc = :id_doc AND id_row = :id_row AND id_scans = :id_scans AND id_user = :id_user',
                                   [
    ...
    public function save()
    {
        ...
        $exists_id = $this->getExist();
    
        if(is_array($exists_id)) {
            $exists_id = $exists_id['id'];
        }
        
        if($exists_id !== NULL && $exists_id !== FALSE) {
            $this->rowDelete(self::TABLE_NAME, 'id = :id', [':id' => $exists_id]);
        }
