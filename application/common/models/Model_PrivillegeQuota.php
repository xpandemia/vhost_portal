...
class Model_PrivillegeQuota
    extends Db_Helper
{
    const TABLE_NAME = 'privilleges_quota';
    ...
    public function get()
    {
        ...
        if( $privillege_quota_record ) {
            ...
            $scan_arr = $scan->getByDocrowFull('priv_quota', $privillege_quota_record['id']);
    ...
    doc_date,
    doc_type',
                                   'privilleges_quota INNER JOIN dict_privilleges
                       ON dict_privilleges.id = privilleges_quota.id_privillege',
                                   'id_user = :id_user',
                                   [ ':id_user' => $_SESSION[APP_CODE]['user_id'] ]);
    }
    ...
    public function clear()
    {
        ...
        if( is_array($my_id) && count($my_id) > 0 && $my_id['id'] == $this->id ) {
