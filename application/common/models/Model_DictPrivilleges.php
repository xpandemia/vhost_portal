...
class Model_DictPrivilleges
    extends Db_Helper
{
    const TABLE_NAME = 'dict_privilleges';
    ...
    public function getAllForQuota()
    {
        return $this->rowSelectAll('b.id, guid, code, name', 'dict_privilleges_quota a
                INNER JOIN dict_privilleges b ON b.code = a.priv_code', NULL, NULL, 'name');
    }
    
    public function getAllForAdvanced()
    {
        return $this->rowSelectAll('b.id, guid, b.code, name', 'dict_privilleges_advanced a
                INNER JOIN dict_privilleges b ON b.code = a.priv_code', NULL, NULL, 'name');
    }
