...
define('ADRREG', [
					...
					'help' => 'Адрес в формате: <strong>Индекс, Страна, Область, Район, Город или Населённый пункт, Улица, Дом, Корпус, Квартира</strong> должен содержать <strong>'.MSG_INFO_RUS.'</strong>, и быть не более <strong>255</strong> символов длиной.']);
define('ADRRES', [
...
define('ADRREG_PAYER', [
    ...
    'help' => 'Адрес в формате: <strong>Индекс, Страна, Область, Район, Город или Населённый пункт, Улица, Дом, Корпус, Квартира</strong> должен содержать <strong>'.MSG_INFO_RUS.'</strong>.'
]);

define('ADRESS_PAYER', [
    'name' => 'Адрес проживания',
    'plc' => 'Индекс, Страна, Область, Район, Город или Населённый пункт, Улица, Дом, Корпус, Квартира',
    'help' => 'Адрес должен содержать <strong>'.MSG_INFO_RUS.'</strong>.'
]);
