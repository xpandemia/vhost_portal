...
<div class="container rounded bg-light pl-5 pr-5 pt-3 pb-3 mt-5">
	<h2><?php echo EDUCTYPES_DOCTYPES['hdr']; ?></h2>
	<?php
		...
		echo HTML_Helper::setGridDB(['model_class' => 'common\\models\\Model_EductypesDoctypes',
									'model_method' => 'getGrid',
									'grid' => 'grid',
									'controller' => EDUCTYPES_DOCTYPES['ctr'],
									'action_add' => 'Add',
									'action_edit' => 'Edit',
									'action_delete' => 'DeleteConfirm',
									'home_hdr' => EDUCTYPES_DOCTYPES['hdr']]);
	?>
</div>
