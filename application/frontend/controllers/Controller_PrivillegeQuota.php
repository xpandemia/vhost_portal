...
require_once ('/var/www/html/vhost_portal/application/common/models/Model_PrivillegeQuota.php');
require_once ('/var/www/html/vhost_portal/application/frontend/models/Model_PrivillegeQuota.php');

use common\models\Model_Resume as Resume;
use frontend\models\Model_Features;
use frontend\models\Model_PrivillegeQuota;
...
class Controller_PrivillegeQuota
    extends parentAlias
{
    public $form;
    ...
    {
        parent::__construct();
        $this->model = new Model_PrivillegeQuota();
        $this->view  = new View();
        // check resume
        $resume     = new Resume();
    ...
    public function actionReset()
    {
        ...
        return $this->view->generate('features-add.php', 'form.php', PRIV_QUOTA['hdr'], $this->form);
    }
    ...
    public function actionAdd()
    {
        ...
        return $this->view->generate('features-quota-add.php', 'form.php', 'Право на прием на обучение за счет бюджетных ассигнований в пределах особой квоты', $this->form);
    }
    ...
    public function actionDelete()
    {
        if( isset($_GET['id']) ) {
            ...
            $this->form['hdr'] = htmlspecialchars(PRIV_QUOTA['hdr']);
            $this->form['ctr'] = htmlspecialchars(PRIV_QUOTA['ctr']);
            ...
            Basic_Helper::redirect('Индивидуальные достижения', 200, PRIV_QUOTA['ctr'], 'Index', NULL, 'Ошибка удаления индивидуального достижения!');
        }
    ...
    public function actionSave()
    {
        ...
        if( $this->form['validate'] ) {
            ...
            if( !$this->form['error_msg'] ) {
                Basic_Helper::redirect('Индивидуальные достижения', 200, PRIV_QUOTA['ctr'], 'Index', $this->form['success_msg']);
            }
    ...
    {
        Basic_Helper::redirect(PRIV_QUOTA['hdr'], 200, PRIV_QUOTA['ctr'], 'Index');
