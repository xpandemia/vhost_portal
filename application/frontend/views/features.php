...
<div class="container rounded bg-light pl-5 pr-5 pt-3 pb-3 mt-5">
    ...
    <div class="row">
        <div class="">
            <h4>Права на прием без вступительных испытаний </h4>
        </div>
        <div class="">
            <!--<button type="button" class="btn btn-info" data-toggle="modal" data-target="#helpIndAchievs">Инструкция</button>-->
        </div>
    ...
    echo HTML_Helper::setGridDB([
									...
									'id' => 'gridDb_priv_qoute1'
                                ]); 
    ?>
    <div class="row">
        <div class="">
            <h4>Право на прием на обучение за счет бюджетных ассигнований в пределах особой квоты </h4>
        </div>
        <div class="">
            <!--<button type="button" class="btn btn-info" data-toggle="modal" data-target="#helpIndAchievs">Инструкция</button>-->
        </div>
    ...
    if( $priv_quota_container === FALSE || $priv_quota_container === NULL ) {
        ...
        echo '<table class="table table-bordered table-hover" id="gridDb_priv_qoute" name="gridDb">'.
				'<thead class="thead-dark"><tr><th class="align-text-top">Тип</th><th class="align-text-top">Номер документа</th><th class="align-text-top">Кем выдан</th></tr></thead>'.
             '<tr>'.
             ...
             '<td>'.HTML_Helper::setHrefButtonIcon(PRIV_QUOTA['ctr'],
                                                   'Edit/?id='.$priv_quota_container['id'], 'font-weight-bold', 'far fa-edit fa-2x', 'Редактировать').
					HTML_Helper::setHrefButtonIcon(PRIV_QUOTA['ctr'],
    ...
    <div class="row">
        <div class="">
            <h4>Преимущественное право зачисления </h4>
        </div>
        <div class="">
            <!--<button type="button" class="btn btn-info" data-toggle="modal" data-target="#helpIndAchievs">Инструкция</button>-->
        </div>
    ...
    if( $priv_adv_container === FALSE || $priv_adv_container === NULL) {
        echo HTML_Helper::setHrefButton('PrivillegeAdvanced', 'Add', 'btn btn-success', 'Д*обавить', 'Д*обавить');
    } else {
        echo '<table class="table table-bordered table-hover" id="gridDb_priv_qoute" name="gridDb">'.
				'<thead class="thead-dark"><tr><th class="align-text-top">Тип</th><th class="align-text-top">Номер документа</th><th class="align-text-top">Кем выдан</th></tr></thead>'.
             '<tr>'.
             ...
             '<td>'.HTML_Helper::setHrefButtonIcon(PRIV_ADV['ctr'],
                                                   'Edit/?id='.$priv_adv_container['id'], 'font-weight-bold', 'far fa-edit fa-2x', 'Редактировать').
             HTML_Helper::setHrefButtonIcon(PRIV_ADV['ctr'],
