...
<div class="container rounded bg-light pl-5 pr-5 pt-3 pb-3 mt-5">
    ...
    echo Form_Helper::setFormBegin(PRIV_ADV['ctr'], PRIV_ADV['act'], PRIV_ADV['id'], PRIV_ADV['hdr'], 0, '/images/logo_bsu_transparent.gif');
    ?>
    ...
    echo Form_Helper::setFormSelectListDB([
                                              ...
                                              'model_method' => 'getAllForAdvanced',
                                              'model_field' => 'code',
    ...
    echo Form_Helper::setFormFileListDB([
                                            ...
                                            'model_filter_var' => 'priv_adv',
                                            'model_field' => 'scan_code',
                                            'model_field_name' => 'scan_name',
                                            'data' => $data,
                                            'home_id' => $data['id'] ?? NULL,
                                            'home_ctr' => PRIV_ADV['ctr'],
                                            'home_hdr' => PRIV_ADV['hdr'],
                                            'home_act' => 'Edit',
                                            'ext' => FILES_EXT_SCANS
                                        ]);
    ?>
    ...
    <div class="form-group">
        <div class="col">
            ...
            if( isset($data['id']) ) {
                echo HTML_Helper::setHrefButton(PRIV_ADV['ctr'], 'Reset', 'btn btn-danger', 'Очистить', 'Сбрасывает данные индивидуального достижения');
            } else {
                echo HTML_Helper::setHrefButton(PRIV_ADV['ctr'], 'Reset', 'btn btn-danger', 'Очистить', 'Обнуляет форму ввода');
            }
            echo HTML_Helper::setHrefButton(PRIV_ADV['ctr'], 'Cancel', 'btn btn-warning', 'Отмена');
            ?>
        </div>
    </div>
    <?php
